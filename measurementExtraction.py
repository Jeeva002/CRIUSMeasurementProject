...
from dicomHandler import dicom_to_png, usImageArea, display_image
from ultrasoundTableAnalyzer import UltrasoundTableDetector
from dicomFileManager import readDirectory
...
def main(dicomDirectory=None):
    ...
    try:
        ...
        logger.info("=== DICOM Processing Session Completed === %s",allMeasurementData)
